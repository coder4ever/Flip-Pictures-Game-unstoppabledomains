...
// import UAuth from '../../../node_modules/@uauth/js'
...
function easyButton() {
  $('.my-card-column-medium, .my-card-column-hard')
    .addClass('invisible')
    .removeClass('visible')
...
function resetGame() {
  $('.face-up')
    .addClass('face-down')
    .removeClass('face-up disabled matched selected')
...
function displayUserData() {
  ...
  switch (userAvatar) {
    case 'strawberry':
      $('#avatar')
        .addClass('strawberry-cover')
        .removeClass('avatar-default toycar-cover plant-cover')
      break
    case 'car':
      $('#avatar')
        .addClass('toycar-cover')
        .removeClass('avatar-default strawberry-cover plant-cover')
      break
    case 'plant':
      $('#avatar')
        .addClass('plant-cover')
        .removeClass('avatar-default strawberry-cover toycar-cover')
      break
    case 'default':
      $('#avatar')
        .addClass('avatar-default')
        .removeClass('plant-cover strawberry-cover toycar-cover')
      break
    default:
      break
  }
